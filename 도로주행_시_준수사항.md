...
menu_order: 1
post_status: publish
post_excerpt: '전동킥보드는 편리하고 경제적인 교통수단으로 인기가 높아지고 있다. 하지만 운전자는 교통안전에 대한 의무를 지니고 있으며, 이를 준수해야 한다. 도로교통법에서 정한 규칙을 따르지 않으면 범칙금을 부과받을 수 있다. 이번 글에서는 전동킥보드 운전자의 교통안전 의무에 대해서 자세히 알아보도록 하겠다.'
