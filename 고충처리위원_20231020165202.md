---
title: " 고충처리위원 배치 및 고충의 처리에 관한 법적 요건"
menu_order: 1
post_status: publish
post_excerpt: '근로자의 고충을 처리하기 위해 고충처리위원을 배치하는 것은 모든 사업이나 사업장에 대한 법적 요건입니다. 근로자참여 및 협력증진에 관한 법률에 따르면, 모든 사업 또는 사업장에는 근로자의 고충을 청취하고 이를 처리하기 위해 고충처리위원을 두어야 합니다. 다만, 상시 30명 미만의 근로자를 사용하는 사업이나 사업장은 고충처리위원을 두지 않을 수 있습니다. 그렇지만 이러한 요건을 어기면 200만원 이하의 벌금이 부과됩니다.'
