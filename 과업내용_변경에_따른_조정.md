...
menu_order: 1
post_status: publish
post_excerpt: '계약 상황에서는 과업내용이 변경될 수 있는 경우가 있다. 이러한 경우에는 계약 담당자와 계약 상대자가 협의하여 과업내용 변경과 조정을 진행해야 한다. 이번 글에서는 계약 상황에서 과업내용 변경과 조정에 대해 알아보고, 관련 법령과 지침을 살펴보도록 하자.'
