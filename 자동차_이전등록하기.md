...
menu_order: 1
post_status: publish
post_excerpt: '중고 자동차를 구매하셨나요  그렇다면 자동차 소유권 이전등록을 해야 한다는 사실을 알고 계셨나요  이전등록은 중고 자동차를 구매한 후 15일 이내에 신청해야 하는 의무입니다. 이전등록 절차와 필요한 서류에 대해 알아보고, 이전등록을 하지 않을 경우에 대한 법적 제재를 알아보도록 하겠습니다.'
